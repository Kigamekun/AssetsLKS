                                ...
                                <tbody>
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td class="align-middle ">
                                                <span
                                                    class="text-secondary text-xs ms-3 font-weight-bold">Rp.{{ number_format($item->price,2,',','.') }}</span>
                                            </td>
                                            <td class="align-middle">
                                                <span
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="price" name="price"
                                placeholder="isi price" required>
                        </div>

                        <div class="mb-3">
                            <label for="stock" class="form-label">stock</label>
                            <input type="number" class="form-control" id="stock" name="stock"
                                placeholder="isi stock" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control dropify" id="thumb" name="thumb"
                                placeholder="isi thumb" required>
                        </div>
                    </div>
            ...
            var html = `
                ...
                <form action="${$(e.relatedTarget).data('url')}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="thumb" class="form-label">thumb</label>
                            <input type="file" class="form-control dropify" id="thumb" data-default-file="${$(e.relatedTarget).data('thumb')}" name="thumb"
